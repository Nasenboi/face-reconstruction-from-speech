...
class PathBuilder:
    ...
    def __init__(self, record: DataSetRecord):
        ...
        self.image_detection_0_path = os.path.join(CONFIG["paths"]["image"], "detections", f"{dataset_id}_0.jpg")
        self.image_detection_1_path = os.path.join(CONFIG["paths"]["image"], "detections", f"{dataset_id}_1.jpg")
        self.image_detection_2_path = os.path.join(CONFIG["paths"]["image"], "detections", f"{dataset_id}_2.jpg")
